...
export const WavyBackground: React.FC<WavyBackgroundProps> = ({
  ...
  useEffect(() => {
    ...
    let w = (canvas.width = container.offsetWidth || window.innerWidth);
    let h = (canvas.height = container.offsetHeight || 400);
    let nt = 0;
    ...
    const render = () => {
      ctx.fillStyle = backgroundFill || "rgba(238, 240, 242, 1)";
  ...
  return (
    ...
    >
      ...
      />
      <div className={className} style={{ position: "relative", zIndex: 10, width: "100%" }}>
        {children}
      </div>
    </div>
  );
